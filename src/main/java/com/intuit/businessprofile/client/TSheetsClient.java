...
@Component
@Slf4j
public class TSheetsClient implements ProductClient {

	private RestTemplate restTemplate;

	public TSheetsClient(@Qualifier("genericClient") RestTemplate restTemplate) {
	...
	public boolean validateProduct(CreateBusinessProfileRequestDTO createBusinessProfileRequestDTO) {
		...
		UriComponents uri = UriComponentsBuilder.fromUriString(Constants.VALIDATION_URL_BASE)
				.path(Constants.VALIDATION_TSSHEETS_URL_PATH).build();
