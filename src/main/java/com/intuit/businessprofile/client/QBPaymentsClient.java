...
@Component
@Slf4j
public class QBPaymentsClient implements ProductClient {

	private RestTemplate restTemplate;

	public QBPaymentsClient(@Qualifier("genericClient") RestTemplate restTemplate) {
